...
describe('Test suite', function (){
    ...
    describe("licenseRestriction functionality", () => {
        it("return correct ouput fo AM", ()=> {
            expect(motorcycleRider.licenseRestriction('AM')).to.equal("Mopeds with a maximum design speed of 45 km. per hour, engine volume is no more than 50 cubic centimeters, and the minimum age is 16.")
        })
        it("return correct ouput fo A1", ()=> {
            expect(motorcycleRider.licenseRestriction('A1')).to.equal("Motorcycles with engine volume is no more than 125 cubic centimeters, maximum power of 11KW. and the minimum age is 16.")
        })
        it("return correct ouput fo A2", ()=> {
            expect(motorcycleRider.licenseRestriction('A2')).to.equal("Motorcycles with maximum power of 35KW. and the minimum age is 18.")
        })
        it("return correct ouput fo A", ()=> {
    ...
    describe('otherSpendings functionality', () => {
        ...
        it('throws for non-boolean discounts', () => {
